    ...
    <>
      ...
      >
        <div className="relative">
          ...
          >
            <div
              className={`${`absolute  z-10 text-center w-[70px] text-[1rem] font-bold  text-white pointer-events-none  transition-opacity duration-200 ease-in-out`}
                ...
                translateX > windowWidth / 10 + 10 ? "opacity-100" : "opacity-0"
              }`}
            >
              LIKE
            </div>
          ...
          {(index === 0 && translateX >= windowWidth / 10 + 10) ||(index === 0 && translateX <= -windowWidth / 10 - 10)||
            (isActive && (
                ...
                >
                  ...
                  >
                    <path
                      ...
                      fill={translateX <= -windowWidth / 10 ? "#FFFFFF" : "#B40335"} // Белый крестик при активном состоянии
                    />
                  </svg>
                </button>
                <button
                ...
                >
                  ...
                  >
                    <path
                      ...
                      fill={translateX >= windowWidth / 10 ? "#FFFFFF" : "#36DE8D"}
                    />
                  </svg>
                </button>
              </div>
